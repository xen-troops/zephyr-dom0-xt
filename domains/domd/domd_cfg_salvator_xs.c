...
struct xen_domain_cfg domd_cfg = {
    .machine_dt_compat = "renesas,salvator-xs",
    .mem_kb = 0x200000, /* 2GB */

    .cmdline = "console=hvc0 root=/dev/nfs nfsroot=10.22.64.15:/home/testrpi1/nfs/h3ulcb,vers=3 ip=dhcp pvrsrvkm.DriverMode=0 clk_ignore_unused",
